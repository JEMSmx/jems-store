...
CREATE TABLE `lc_slides` (
  ...
  `image_mobile` varchar(64) NOT NULL,
...
-- --------------------------------------------------------
CREATE TABLE `lc_products_videos` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `product_id` int(11) NOT NULL,
  `link` varchar(256) NOT NULL,
  `priority` tinyint(2) NOT NULL,
...
-- --------------------------------------------------------
CREATE TABLE `k_product_showcases_row` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `status` tinyint(1) NOT NULL,
  `product_id` int(11) NOT NULL,
  `priority` tinyint(2) NOT NULL,
...
-- --------------------------------------------------------
CREATE TABLE `k_product_showcases_column` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `showcase_row_id` int(11) NOT NULL,
  `title` varchar(128) NOT NULL,
  `subtitle` varchar(128) NOT NULL,
  `align_text` varchar(128) NOT NULL,
  `background_color` varchar(128) NOT NULL,
  `scheme_color` varchar(128) NOT NULL,
  `image` varchar(256) NOT NULL,
  `priority` tinyint(2) NOT NULL,
  `date_updated` datetime NOT NULL,
  `date_created` datetime NOT NULL,
  PRIMARY KEY (`id`),
  KEY `showcase_row_id` (`showcase_row_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COLLATE {DATABASE_COLLATION};
