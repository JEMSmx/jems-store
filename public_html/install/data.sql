...
(0, 'USD', '840', 'US Dollars', 1, 2, '$', '', 0, NOW(), NOW()),
(0, 'EUR', '978', 'Euros', 0.726, 2, '', ' €', 0, NOW(), NOW()),
(1, 'MXN', '484', 'Peso Mexicano', 1, 2, '$', '', 0, NOW(), NOW());
-- --------------------------------------------------------
...
(0, 'en', 'eng', 'English', 'en_US.utf8,en_US.UTF-8,english', 'UTF-8', 'm/d/y', 'h:i:s A', 'm/d/y h:i:s A', '%b %e %Y', '%I:%M %p', '%b %e %Y %I:%M %p', '.', ',', 0, NOW(), NOW()),
(1, 'es', 'esp', 'Spanish', '', 'UTF-8', 'Y-m-d', 'h:i A', 'Y-m-d h:i A', '%e %b %Y', '%I:%M %P', '%e %b %Y %I:%M %P', '.', ',', 0, NOW(), NOW());
-- --------------------------------------------------------
...
('display', 'Display', 'Catalog submenu default settings', 35),
...
('site', 'Site settings', 'Site settings', 100),
...
('store_info', 'local', 'Store Tax ID', 'The store tax ID or VATIN.', 'store_tax_id', '', 'input()', 12, NOW(), NOW()),
('store_info', 'local', 'Store Postal Address', 'The store postal address.', 'store_postal_address', '', 'bigtext()', 13, NOW(), NOW()),
...
('store_info', 'local', 'Store Phone Number', 'The store phone number.', 'store_phone', '', 'input()', 15, NOW(), NOW()),
...
('store_info', 'local', 'Store Language', 'The spoken language of your organization.', 'store_language_code', 'es', 'languages()', 18, NOW(), NOW()),
('store_info', 'global', 'Store Currency', 'The currency of which all prices conform to.', 'store_currency_code', 'MXN', 'currencies()', 19, NOW(), NOW()),
...
('store_social', 'local', 'Facebook', 'Url Facebook', 'url_facebook', '', 'input()', 22, NOW(), NOW()),
('store_social', 'local', 'Twitter', 'Url Twitter', 'url_twitter', '', 'input()', 22, NOW(), NOW()),
('store_social', 'local', 'Google +', 'Url Google +', 'url_google', '', 'input()', 22, NOW(), NOW()),
('store_social', 'local', 'Pinterest', 'Url Pinterest', 'url_pinterest', '', 'input()', 22, NOW(), NOW()),
('store_social', 'local', 'Instagram', 'Url Instagram', 'url_instagram', '', 'input()', 22, NOW(), NOW()),
('defaults', 'global', 'Default Language', 'The default language selected, if failed to identify.', 'default_language_code', 'es', 'languages()', 10, NOW(), NOW()),
('defaults', 'global', 'Default Currency', 'The default currency selected, if failed to identify.', 'default_currency_code', 'MXN', 'currencies()', 11, NOW(), NOW()),
...
('general', 'global', 'Set Currency by Language', 'Chain select currency when changing language.', 'set_currency_by_language', '0', 'toggle()', 10, NOW(), NOW()),
...
('display', 'local', 'Product groups', 'Disables catalog option product groups', 'product_groups_setting', '0', 'toggle("t/f")', 10, NOW(), NOW()),
('display', 'local', 'Option groups', 'Disables catalog option groups', 'option_groups_setting', '0', 'toggle("t/f")', 10, NOW(), NOW()),
('display', 'local', 'Manufacturers', 'Disables catalog option manufacturer', 'manufacturers_setting', '0', 'toggle("t/f")', 10, NOW(), NOW()),
('display', 'local', 'Suppliers', 'Disables catalog option suppliers', 'suppliers_setting', '0', 'toggle("t/f")', 10, NOW(), NOW()),
('display', 'local', 'Manage category', 'Disables catalog option manage category', 'manage_category_setting', '1', 'toggle("t/f")', 10, NOW(), NOW()),
...
('listings', 'local', 'Similar Products Box: Number of Items', 'The maximum amount of items to be display in the box.', 'box_similar_products_num_items', '4', 'int()', 15, NOW(), NOW()),
...
('listings', 'local', 'Latest Products Box: Number of Items', 'The maximum amount of items to be display in the box.', 'box_latest_products_num_items', '4', 'int()', 17, NOW(), NOW()),
('listings', 'local', 'Most Popular Products Box: Number of Items', 'The maximum amount of items to be display in the box.', 'box_most_popular_products_num_items', '4', 'int()', 18, NOW(), NOW()),
...
('advanced', 'global', 'SEO Links Language Prefix', 'Begins the SEO links with the language code i.e. /en/....', 'seo_links_language_prefix', '0', 'toggle()', 13, NOW(), NOW()),
...
('advanced', 'local', 'Input Language Flag Icons', 'Disable input language flag icons', 'input_language_flag_icons', '0', 'toggle()', 14, NOW(), NOW()),
...
('advanced', 'global', 'Google Analytics Id', 'Google Analytics Id', 'google_analytics_id', '', 'input()', 20, NOW(), NOW()),
...
('security', 'local', 'CAPTCHA', 'Prevent robots from posting form data by enabling CAPTCHA security.', 'captcha_enabled', '0', 'toggle()', 15, NOW(), NOW()),
...
('site_settings', 'local', 'Promo message', 'Message promo banner', 'promo_message', '', 'input()', 1, NOW(), NOW()),
('site_settings', 'local', 'Footer banner header', 'Footer banner header', 'footer_banner_header', '', 'input()', 1, NOW(), NOW()),
('site_settings', 'local', 'Footer banner subtitle', 'Footer banner subtitle', 'footer_banner_subtitle', '', 'input()', 2, NOW(), NOW()),
('site_settings', 'local', 'Footer banner button', 'Footer banner button', 'footer_banner_button', '', 'input()', 3, NOW(), NOW()),
('site_settings', 'local', 'Footer banner button link', 'Footer banner button link', 'footer_banner_button_link', '', 'input()', 4, NOW(), NOW()),
