...
<?php
    ...
    // Output subcategories
      ...
      while ($category = database::fetch($categories_query)) {
        ...
        if (settings::get('manage_category_setting')){ 
