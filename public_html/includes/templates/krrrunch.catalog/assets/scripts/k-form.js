...
//---------------------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------------
// Thanks to floatl.js developed by: https://github.com/richardvenneman -- official github site: https://github.com/richardvenneman/floatl
//---------------------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------------
//---------------------------------------------------------------------------------------------------------------------------------------
...
module.exports = Floatl = (function() {
  ...
  FOCUSED_CLASS = 'k-input--focused';

  ACTIVE_CLASS = 'k-input--active';

  function Floatl(element) {
    this.handleChange = bind(this.handleChange, this);
    var event, i, len, ref;
    this.element = this.getElement(element);
    this.label = this.element.querySelectorAll('.k-input__label')[0];
    this.input = this.element.querySelectorAll('.k-input__input')[0];
...
// script to style <select> elements

 $( ".k-select" ).focusin(function() {
        $( this ).toggleClass('k-select--open');
});
$( ".k-select" ).focusout(function() {
        $( this ).toggleClass('k-select--open');
});

$(document).on('change','.k-select__select',function(){
    $(this).parent().addClass('k-select--changed');
});