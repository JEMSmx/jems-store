      ...
      switch($field) {
        ...
        case 'showcases':
          ...
          while ($product_showcase = database::fetch($product_showcases_query)) {
            $this->_data['showcases'][$product_showcase['id']] = $product_showcase;
            $this->_data['showcases'][$product_showcase['id']]['showcase_columns']=array();
            ...
            $this->_data['showcases'][$product_showcase['id']]['showcase_columns'][$product_showcase_column['id']] = $product_showcase_column;
            }
          }
        ...
        case 'videos':
          ...
          while ($row = database::fetch($query)) {
            $this->_data['videos'][$row['id']] = $row['link'];
          }
